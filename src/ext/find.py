...
from PySide2.QtWidgets import QWidget, QTextEdit, QPushButton, QLabel, QDialog, QRadioButton, QCheckBox, QGridLayout
...
class Find(QDialog):
    ...
    def replace(self):
        ...
        if self.lastMatch and cursor.hasSelection():
            ...
            self.parent.paged_text_edit.setTextCursor(cursor)
